...
class Camera(nn.Module):
    def __init__(self, colmap_id,  R, T, K, FoVx, FoVy, image,image_o,image_h, gt_alpha_mask,
                 image_name, uid,save_obj,obj_faces,cam_trans,cam_param,img_vis,face_sim,
                 bkgd_mask=None,bkgd_mask_o=None,bkgd_mask_h=None, bound_mask=None, smpl_param=None,
        ...
        self.bkgd_mask_o = bkgd_mask_o
        self.bkgd_mask_h = bkgd_mask_h
        ...
        self.original_image_o=image_o.clamp(0.0, 1.0)#.to(self.data_device)
        self.original_image_h=image_h.clamp(0.0, 1.0)#.to(self.data_device)
