...
# # Example usage:
# center = (0, 0, 0)  # Center of the Gaussian in 3D
# scaling = (1, 2, 1.5)  # Scaling factors for x, y, z (σx, σy, σz)
# rotation = (45, 30, 60)  # Rotation angles around x, y, z in degrees
# filename = 'gaussian_ellipsoid.obj'  # Filename to save
#
# # Save the ellipsoid as an .obj file
# save_ellipsoid_as_obj(center, scaling, rotation, filename)
