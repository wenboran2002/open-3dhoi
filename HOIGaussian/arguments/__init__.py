...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.position_lr_init = 0.0000006
        self.obj_lr_init = 0.01
        self.angle_lr_init = 0.01
        self.obj_scale_init = 0.05
        self.position_lr_final = 0.000000016
        self.position_lr_delay_mult = 0.01
        self.position_lr_max_steps = 30_000
        self.feature_lr = 0.0005
        self.opacity_lr = 0.05
        self.scaling_lr = 0.005
        self.rotation_lr = 0.001
        self.pose_refine_lr = 0.00001
        self.lbs_offset_lr = 0.00001
